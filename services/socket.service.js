...
function setupSocketAPI(http) {
    ...
    gIo.on('connection', socket => {
        ...
        socket.on('pull any', (anyId) => {
            logger.debug('socket.on - pull any')
            broadcast({ type: 'any update', data: anyId, room: socket.myTopic, userId: socket.userId })
            // gIo.to(socket.myTopic).emit('any update', 'updating any')
